...
<head>
    ...
    <title>CityResolve - Complaint Details</title>
    ...
    <div class="main-content">
        <section class="form-section">
            <div class="form-container">
                <h2 class="form-title">
                    <i class="bi bi-info-circle"></i> Complaint Details
                </h2>
                <div class="form-group">
                    <label class="form-label"><strong>Complaint ID:</strong></label>
                    <p>{{ $complaint->id }}</p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    @if($complaint->photo)
                        <img src="{{ asset('storage/' . $complaint->photo) }}" alt="Complaint Photo" width="200">
                    @else
                        <p>Not provided</p>
                    @endif
                </div>
                ...
                <a href="/submit" class="btn btn-primary mt-3">Back to Submit</a>
            </div>
        </section>
    </div>
